...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CargoTracking.Server.Domain.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CargoTracking.Server.Domain.Employees.Employee", b =>
                {
                    b.OwnsOne("CargoTracking.Server.Domain.Employees.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("CargoTracking.Server.Domain.Employees.PersonelInformation", "PersonelInformation", b1 =>
                        {
                            b1.Property<Guid>("EmployeeId")
                                .HasColumnType("uniqueidentifier");
